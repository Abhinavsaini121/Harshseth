...
const Therapist = () => {
  return (
    <div className="p-6">
      <h2 className="text-2xl font-semibold mb-6">Therapist Management</h2>
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <input
          ...
          className="border px-3 py-2 rounded-md w-60 shadow-sm"
        />
        <select className="border px-3 py-2 rounded-md shadow-sm">
          ...
          <tbody>
            {therapists.map((therapist, index) => (
              <tr key={index} className="border-t hover:bg-gray-50">
                ...
                <td className="px-4 py-3">
                  D:{therapist.sessions.daily} / W:{therapist.sessions.weekly} / M:
                  {therapist.sessions.monthly}
                </td>
